...
import PetButon from "./pet-button";
        ...
        <>
          <div className="flex items-center bg-white px-8 py-5 border-b border-light">
            ...
            <div className="ml-auto space-x-2">
              <PetButon actionType="edit">Edit</PetButon>
              <PetButon
                actionType="checkout"
          ...
          <section className="flex-1 bg-white mb-9 mx-8 px-7 py-5 rounded-md border border-light">
            {selectedPet.notes}
          </section>
        </>
      )}
